...
La memoria principal está organizada en una matriz de $16 \times 16$ celdas de 8 bits, segmentada de la siguiente manera:
...
## 4. Algoritmo Demostrativo: Multiplicación por Sumas Sucesivas ($3 \times 4 = 12$)

El programa demostrativo cargado en la memoria RAM resuelve la multiplicación de $3 \times 4$ sumando el valor `04h` un total de 3 veces dentro de un bucle controlado por `BX` y la instrucción `JNZ`.
